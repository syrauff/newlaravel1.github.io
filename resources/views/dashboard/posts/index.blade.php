...
<div class="table-responsive col-lg-8">
  <a href="/dashboard/posts/create" class="btn btn-primary mb-3">Create a post</a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/dashboard/posts/{{$post->slug}}/edit" class="badge bg-warning"><span data-feather="edit-2" class="align-text-bottom"></span></a>
            ...
            <a href="/dashboard/posts/{{$post->slug}}" class="badge bg-danger"></a>
          </td>
        </tr>
        @endforeach
