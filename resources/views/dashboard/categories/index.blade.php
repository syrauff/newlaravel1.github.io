      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/dashboard/categories/{{$category->slug}}/edit" class="badge bg-warning"><span data-feather="edit-2" class="align-text-bottom"></span></a>
            ...
            <a href="/dashboard/posts/{{$category->slug}}" class="badge bg-danger"></a>
          </td>
        </tr>
        @endforeach
